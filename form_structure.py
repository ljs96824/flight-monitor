    ...
    values.update(
        {
            ...
            "buffer_hours": _first_defined(hard.get("buffer_hours"), constraints.get("buffer_hours"), data.get("buffer_hours"), default=""),
            "transport_mode": _first_defined(hard.get("transport_mode"), constraints.get("transport_mode"), data.get("transport_mode"), default=""),
