...
def _concept(
    ...
    *,
    ...
    return {
        ...
        "canonical_input_names": tuple(declared_fields if canonical_input_names is None else canonical_input_names),
...
CONCEPTS = {
    ...
    "companion_constraints": _concept(
        "flight_preferences",
        "行动便利",
        ("mobility_limited",),
        ("preferences.companion_constraints", "preferences.mobility_limited"),
        canonical_input_names=("mobility_limited",),
    ),
    ...
    "cabin": _concept(
        ...
        (
            "cabin_classes",
            "constraints.cabin_arrangement",
            "constraints.business_seats",
            "constraints.economy_seats",
            "constraints.cabin_allocation",
        ),
        canonical_input_names=(
            "cabin_policy",
            "cabin_arrangement",
